# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-22 22:10
...
def get_root_collection_id():
    """Get the root collection ID for migrations compatibility."""
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Blog_page_tag_select', to='lampstands.BlogPageTagList')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
