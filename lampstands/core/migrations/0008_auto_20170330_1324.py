...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=wagtail.wagtailcore.fields.StreamField((('indexpreview', wagtail.wagtailcore.blocks.TextBlock(max_length=300)),), blank=True, help_text='To show a summarized version in the index page only'),
        ),
        migrations.AddField(
            model_name='blogpage',
            name='previewstreamfield',
            field=wagtail.wagtailcore.fields.StreamField((('indexpreview', wagtail.wagtailcore.blocks.TextBlock(max_length=400)),), blank=True, help_text='To show a summarized version in the index page only'),
        ),
        migrations.AlterField(
            model_name='beliefspage',
            name='streamfield',
            field=wagtail.wagtailcore.fields.StreamField((('wholestory', wagtail.wagtailcore.blocks.StreamBlock((('h2', wagtail.wagtailcore.blocks.CharBlock(classname='title', icon='title')), ('h3', wagtail.wagtailcore.blocks.CharBlock(classname='title', icon='title')), ('h4', wagtail.wagtailcore.blocks.CharBlock(classname='title', icon='title')), ('intro', wagtail.wagtailcore.blocks.RichTextBlock(icon='pilcrow')), ('paragraph', wagtail.wagtailcore.blocks.RichTextBlock(icon='pilcrow')), ('aligned_image', wagtail.wagtailcore.blocks.StructBlock((('image', wagtail.wagtailimages.blocks.ImageChooserBlock()), ('alignment', lampstands.core.models.ImageFormatChoiceBlock()), ('caption', wagtail.wagtailcore.blocks.CharBlock()), ('attribution', wagtail.wagtailcore.blocks.CharBlock(required=False))), label='Aligned image')), ('wide_image', wagtail.wagtailcore.blocks.StructBlock((('image', wagtail.wagtailimages.blocks.ImageChooserBlock()),), label='Wide image')), ('bustout', wagtail.wagtailcore.blocks.StructBlock((('image', wagtail.wagtailimages.blocks.ImageChooserBlock()), ('text', wagtail.wagtailcore.blocks.RichTextBlock())))), ('pullquote', wagtail.wagtailcore.blocks.StructBlock((('quote', wagtail.wagtailcore.blocks.CharBlock(classname='quote title')), ('attribution', wagtail.wagtailcore.blocks.CharBlock())))), ('raw_html', wagtail.wagtailcore.blocks.RawHTMLBlock(icon='code', label='Raw HTML')), ('embed', wagtail.wagtailembeds.blocks.EmbedBlock(icon='code'))))),), help_text='Use Raw HTML option if dropcaps etc. are needed to customize look'),
        ),
        migrations.AlterField(
            model_name='blogpage',
            name='streamfield',
