...
class ChurchPage(Page):
    ...
    locality_email = models.EmailField(blank=False, null=True)
    #locality_web = models.TextField(validators=[URLValidator()], blank=True, help_text= "Please type: 'http://' in the front of the URL")
    locality_web = models.TextField(blank=False, null=True, help_text= "Please type: 'http://' in the front of the URL")
